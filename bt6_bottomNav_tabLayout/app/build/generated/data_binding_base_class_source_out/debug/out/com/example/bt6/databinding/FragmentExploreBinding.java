...
public final class FragmentExploreBinding implements ViewBinding {
  ...
  private FragmentExploreBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView) {
  ...
  public static FragmentExploreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentExploreBinding((ConstraintLayout) rootView, imageView);
    }
