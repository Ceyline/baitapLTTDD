...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapping();
        username_input.setText(share.getString("username", ""));
        password_input.setText(share.getString("password", ""));
        switchRemember.setChecked(share.getBoolean("checked", false));
        ControlButton();
    }
    ...
    public void LoginEvent() {
        ...
        if (!flag) {
            ...
            hoten_output.setText(hoten_output.getText().toString() + " " + username);
